...
def train(td,
    ...
    for iteration in range(1, maxiter+1):
        ...
        for w,d in zip(*td.nonzero()):
            ...
            print "p_z_d_w.shape=", p_z_d_w.shape, "\tp_z_old.shape=", p_z_old.shape, "\tp_d_z_old[d,:].shape=", p_d_z_old[d,:].shape, "\tp_w_z_old[w,:].shape=", p_w_z_old[w,:].shape
...
class pLSA(object):
    ...
    def train(self, td, Z, maxiter=500, eps=0.01, folding_in=False):
        ...
        train_func = train #_plsa.train if HAVE_EXT else train
